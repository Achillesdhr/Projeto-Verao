...
def alimentos():
    return {'CARNES E OVOS': [['ALMONDEGA', 51], ['BIFE', 56], ['CARNE DE PANELA', 21], ['BISTECA', 98], ['ALMONDEGA', 23],
                              ['CARNE BOVINA GORDA', 63], ['CARNE MOIDA', 45], [
        'COXA DE FRANGO', 27], ['FRANGO GRELHADO', 32],
        ['HAMBURGUER BOVINO', 30], ['HAMBURGUER FRANGO', 23], [
        'LINGUIÇA', 45], ['OMELETE', 40], ['OVO', 23],
        ...
        'FRUTAS': [['ABACAXI', 10], ['BANANA MAÇA', 20], ['BANANA NANICA', 30], ['BANANA PRATA', 20], ['LARANJA', 3],
                   ['MAÇÃ', 25], ['MAMÃO', 10], ['MANGA', 5], ['MELANCIA', 10], [
            'SALADA DE FRUTA', 5], ['TANGERINA', 15],
        ['TOMATE', 5]],
        ...
        'PAES E BOLACHAS': [['BISCOITO DE LEITE', 7], ['BISCOITO RECHEADO', 20], ['BISNAGUINHA', 20],
                            ['PÃO CASEIRO', 46], ['PÃO DE BATATA', 40], [
            'PÃO DE FORMA', 20], ['PÃO FRANCES', 40],
...
def carnes_ovos():
    ...
    print('')
    calorias = alimentos()['CARNES E OVOS'][escolha_alimento()
                                            ][1] * quantidade_alimento()
    print('')
...
def frutas():
    ...
    calorias = alimentos()['FRUTAS'][escolha_alimento()
                                     ][1] * quantidade_alimento()
    print('')
    print(f'voce ingeriu {calorias} calorias')
    return calorias
...
def graos():
    ...
    calorias = alimentos()['GRÃOS'][escolha_alimento()
                                    ][1] * quantidade_alimento()
    print('')
    print(f'voce ingeriu {calorias} calorias')
    return calorias
...
def peixes():
    ...
    calorias = alimentos()['PEIXES'][escolha_alimento()
                                     ][1] * quantidade_alimento()
    print('')
    print(f'voce ingeriu {calorias} calorias')
    return calorias
...
def leites_iogurtes():
    ...
    calorias = alimentos()[
        'LEITES E IOGURTES'][escolha_alimento()][1] * quantidade_alimento()
    print('')
    print(f'voce ingeriu {calorias} calorias')
    return calorias
...
def paes_bolachas():
    ...
    calorias = alimentos()[
        'PAES E BOLACHAS'][escolha_alimento()][1] * quantidade_alimento()
    print('')
    print(f'voce ingeriu {calorias} calorias')
    return calorias
...
def queijos():
    ...
    calorias = alimentos()['QUEIJOS'][escolha_alimento()
                                      ][1] * quantidade_alimento()
    print('')
    print(f'voce ingeriu {calorias} calorias')
    return calorias
...
def bolos():
    ...
    calorias = alimentos()['BOLOS'][escolha_alimento()
                                    ][1] * quantidade_alimento()
    print('')
    print(f'voce ingeriu {calorias} calorias')
    return calorias
...
def bebidas():
    ...
    calorias = alimentos()['BEBIDAS'][escolha_alimento()
                                      ][1] * quantidade_alimento()
    print('')
    print(f'voce ingeriu {calorias} calorias')
    return calorias
...
def doces():
    ...
    calorias = alimentos()['DOCES'][escolha_alimento()
                                    ][1] * quantidade_alimento()
    print('')
    print(f'voce ingeriu {calorias} calorias')
    return calorias
...
def pizzas():
    ...
    calorias = alimentos()['PIZZAS'][escolha_alimento()
                                     ][1] * quantidade_alimento()
    print('')
    print(f'voce ingeriu {calorias} calorias')
    return calorias
...
def cafe(total):
    cafe = total
    print(f'O total de calorias ingeridas no café foi de : {cafe * 3.611} ')


def almoco(total):
    almoco = total
    print(f'O total de calorias ingeridas no almoço foi: {almoco * 3.611} ')


def janta(total):
    janta = total
    print(f'O total de calorias ingeridas na janta foi: {janta * 3.611}')
